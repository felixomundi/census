...
$name=$_POST['name'];
$status=1;
$sql="INSERT INTO  loc(name,status) VALUES(:name,:status)";
...
<h3 class="text-dark mb-4">Create Location</h3>
<div class="row mb-3">
<div class="col-lg-8">
...
<p class="text-primary m-0 font-weight-bold">Create Location</p>
</div>
<div class="card-body">
