...
$status=1;
$sql="INSERT INTO  village(name,sub_id,status) VALUES(:name,:sub_id,:status)";
...
if($lastInsertId)
{
$msg="Village Created successfully";
}
else 
{
...
<title>Create Village Location</title>
...
<h3 class="text-dark mb-4">Create Village Location</h3>
<div class="row mb-3">
<div class="col-lg-8">
...
<p class="text-primary m-0 font-weight-bold">Create Village Location</p>
</div>
<div class="card-body">
...
<?php $ret="select id, name from sub";
...
<div class="form-group">
<label for="exampleInputUsername1">Village Name</label>
