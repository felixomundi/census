...
$name=$_POST['name'];
$id=$_GET['id'];
$sql="update  village set name=:name where id=:id";
...
<title>Edit Village Location</title>
...
<h3 class="text-dark mb-4">Update Village Details</h3>
<div class="row mb-3">
<div class="col-lg-8">
...
<?php
$id=$_GET['id'];
$ret="select * from village where id=:id";
