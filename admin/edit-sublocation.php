...
$name=$_POST['name'];
$id=$_GET['id'];
$sql="update  sub set name=:name where id=:id";
...
$msg="Sub location updated successfully";
...
<h3 class="text-dark mb-4">Update Sub Location Details</h3>
<div class="row mb-3">
<div class="col-lg-8">
...
<?php
$id=$_GET['id'];
$ret="select * from sub where id=:id";
